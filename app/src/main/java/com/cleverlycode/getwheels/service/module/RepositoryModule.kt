...
import com.cleverlycode.getwheels.data.repositories.FavoritesRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindsFavoritesRepository(impl: FavoritesRepositoryImpl): FavoritesRepository
